...
function Careers() {
    return (
        <div className="min-h-screen bg-white text-zinc-900">
            <Head>
                <title>Careers | Endeavor</title>
                <meta
                    property="og:title"
                    content="Careers - Endeavor"
                />
                <meta
                    property="og:description"
                    content="Join us and help build the future of AI-powered industrial automation"
                />
            ...
            <main className="mx-auto max-w-4xl px-4 sm:px-6 md:px-8 pt-28 pb-12 leading-relaxed" style={{ fontFamily: "'Anonymous Pro', monospace" }}>
                ...
                <p className="mb-6">
                    Sam Altman writes in a 2025 blog post (The Gentle Singularity):
                </p>

                <blockquote className="border-l-4 border-zinc-500 pl-4 mb-6 italic text-zinc-700">
